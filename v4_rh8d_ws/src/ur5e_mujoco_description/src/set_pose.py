...
Run the code:
    python3 set_pose.py --scene /home/ehtisham/Desktop/Robotics_uclv/03_PROJECTS/P1_rh8d_sim/2-MuJoCo/ros2_control_moveit/v4_rh8d_ws/src/ur5e_mujoco_description/mjcf/ur5e_rh8d_scene.xml
...
def main():
    ...
    set_actuator_ctrl(m, d, "pos_palmL", hand_pose["palmL:1--palm_axis:1"])
    set_actuator_ctrl(m, d, "pos_thumb_axis", hand_pose["Thumb_axis--palmL:1"])
    set_actuator_ctrl(m, d, "pos_thumb_tendon", hand_pose["Thumb_Methacarpal--Thumb_axis"])
    set_actuator_ctrl(m, d, "pos_index_tendon", hand_pose["Index_Proximal--palmL:1"])
    set_actuator_ctrl(m, d, "pos_middle_tendon", hand_pose["Middle_Proximal--palmL:1"])
    set_actuator_ctrl(m, d, "pos_ring_small_tendon", hand_pose["Ring_Proximal--palmL:1"])
